	...
	return (
		<div className={classes.wrapper}>
			{loading ? (
				...
				<Grid container>
					<Grid item xs={2} sm={1} className={classes.areaWrapperLeft}>
					...
					<Grid item xs={10} sm={11} className={classes.areaWrapperRight}>
						{selectedGame != null ? (
							<div className={classes.area}>
								<div className={classes.welcome}>{selectedGame.game.name}</div>
								<Grid container >
									<Servers />
								</Grid>
								<Download />
